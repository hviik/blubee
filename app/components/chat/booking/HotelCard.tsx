...
export function HotelCard({ hotel, onBook }: HotelCardProps) {
  ...
  return (
    <div className="group flex flex-col bg-white rounded-lg shadow-[0_0_16px_rgba(0,0,0,0.1),0_4px_4px_rgba(0,0,0,0.1)] overflow-hidden w-[250px] flex-shrink-0 hover:shadow-lg transition-shadow duration-200">
      {/* Hotel Image */}
